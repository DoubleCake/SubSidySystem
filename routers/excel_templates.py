...
SYSTEM_FIELDS = {
    "FARMER": [
        ...
        {"field": "contract_area",    "label": "承包面积", "required": False, "type": "decimal"},
...
BUILTIN_ALIASES = {
    ...
    "gender":        ["性别", "性 别"],
    "actual_amount": ["发放金额", "补贴金额", "实发金额", "金额", "应发金额", "补贴（元）","补贴金额（元）", "发放金额（元）", "发放额", "打款金额"],
    "apply_area":    ["种植面积", "申请面积", "补贴面积", "计补面积", "补贴面积（亩）","种植面积（亩）", "申请面积（亩）"],
    "apply_area_no_calc": ["不计入超限面积", "不计超限面积", "不计入超限计算的补贴面积", "不参与计算面积", "不计入计算面积(亩)"],
    "pay_date":      ["打款日期", "发放日期", "付款日期", "拨付日期", "到账日期"],
    "remark":        ["备注", "说明", "备注信息"],
    "contract_area": ["承包地种植面积", "承包耕地种植面积","承包面积", "二轮承包面积", "承包地", "二轮承包地面积", "承包地面积(亩)", "承包面积(亩)","土地面积*",  "承包面积", "土地面积（亩）", "耕地面积", "亩数", "承包面积(亩)"],
    "trust_area":    ["代耕代种面积", "代耕代种植面积和流转面积", "代种面积", "托管面积", "代耕面积", "代耕代种面积(亩)", "代种面积(亩)", "代耕代种土地流转","代耕代种和流转面积(亩)"],
